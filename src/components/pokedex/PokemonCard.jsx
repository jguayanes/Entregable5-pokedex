...
import {
  bgStylePokemonByTypes,
  borderStylePokemonTypes,
  ...
  return (
    <Link
      ...
      className={`text-center capitalize border-[5px] rounded-md ${
        borderStylePokemonTypes[pokemonInfo?.types[0]]
      }`}
    >
      <header
        className={`h-[80px] relative mb-10 ${
          bgStylePokemonByTypes[pokemonInfo?.types[0]]
        }`}
      >
      ...
      <section>
        ...
        <h5 className="text-sm mb-2 font-bold">Types</h5>
        <hr />
